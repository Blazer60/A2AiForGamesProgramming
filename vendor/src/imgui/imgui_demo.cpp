...
static void ShowDemoWindowLayout()
{
    ...
    if (ImGui::TreeNode("Scrolling"))
    {
        ...
        ImGui::Checkbox("Show Horizontal contents stride demo window", &show_horizontal_contents_size_demo_window);
        ...
        if (show_horizontal_contents_size_demo_window)
        {
            ...
            ImGui::Begin("Horizontal contents stride demo window", &show_horizontal_contents_size_demo_window, show_h_scrollbar ? ImGuiWindowFlags_HorizontalScrollbar : 0);
            ...
            ImGui::Checkbox("Explicit content stride", &explicit_content_size);
    ...
    if (ImGui::TreeNode("Clipping"))
    {
        ...
        ImGui::DragFloat2("stride", (float*)&size, 0.5f, 1.0f, 200.0f, "%.0f");
...
static void ShowDemoWindowTables()
{
    ...
    if (ImGui::TreeNode("Sizing policies"))
    {
        ...
        {
            ImGui::SameLine();
            HelpMarker("Be mindful that using right-alignment (e.g. stride.x = -FLT_MIN) creates a feedback loop where contents width can feed into auto-column width can feed into contents width.");
        }
    ...
    if (open_action != -1)
        ImGui::SetNextItemOpen(open_action != 0);
    if (ImGui::TreeNode("Outer stride"))
    {
        ...
        ImGui::Text("Using explicit stride:");
        ...
        if (ImGui::TreeNode("Options"))
        {
            ...
            if (ImGui::TreeNodeEx("Other:", ImGuiTreeNodeFlags_DefaultOpen))
            {
                ...
                HelpMarker("If scrolling is disabled (ScrollX and ScrollY not set):\n"
                    ...
                    "- OuterSize.y then becomes the minimum stride for the table, which will extend vertically if there are more rows (unless NoHostExtendY is set).");
    ...
    if (ImGui::BeginTabBar("##tabs", ImGuiTabBarFlags_None))
    {
        ...
        if (ImGui::BeginTabItem("Fonts"))
        {
            ...
            HelpMarker(
                ...
                "However, the _correct_ way of scaling your UI is currently to reload your font at the designed stride, "
...
static void ShowExampleAppAutoResize(bool* p_open)
{
    ...
    ImGui::TextUnformatted(
        "Window will resize every-frame to the stride of its content.\n"
        "Note that you probably don't want to query the window stride to\n"
